...
```
##  int [1:100] 10 13 16 17 21 23 26 27 32 33 ...
```
...
```
##  int [1:50] 1 2 3 4 6 7 8 12 15 19 ...
```
...
```
##  int [1:256] 6 8 12 17 24 27 34 35 39 40 ...
```
...
```
##  int [1:512] 1 2 4 5 9 11 13 14 15 19 ...
```
...
## 
## 1) root 512 174 neg (0.3398 0.6602)  
##   2) glucose>=127.5 193  80 pos (0.5855 0.4145)  
##     4) mass>=29.85 148  42 pos (0.7162 0.2838) *
##     5) mass< 29.85 45   7 neg (0.1556 0.8444) *
##   3) glucose< 127.5 319  61 neg (0.1912 0.8088) *
```
...
##          6   neg      neg   0.1912   0.8088
##          8   neg      neg   0.1912   0.8088
##         12   pos      pos   0.7162   0.2838
## ---                                        
##        761   neg      neg   0.1880   0.8120
##        763   neg      neg   0.1880   0.8120
##        767   pos      neg   0.1880   0.8120
```
...
##         12   pos      pos   0.7162   0.2838
## ---                                        
##        762   pos      pos   0.7162   0.2838
##        766   neg      neg   0.1912   0.8088
##        768   neg      neg   0.1912   0.8088
```
